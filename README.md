...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    html, body { height: 100%; font-family: "Audiowide", "Bebas Neue", Inter, sans-serif; color: #fff; overflow-x: hidden; }
    a { color: inherit; text-decoration: none; }

    /* Background poster */
    .bg {
      position: fixed; inset: 0;
      background-image: url('IMG_1703.jpeg');
    ...
    .overlay {
      position: fixed; inset: 0;
      background: linear-gradient(90deg, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.6) 60%, rgba(10,10,10,0.35) 100%);
      z-index: -1;
    }
    ...
    nav a {
      color: #fff; opacity: 0.9; font-size: 16px;
    }
    nav a:hover {
    ...
    /* Hero / main */
    main {
      margin-top: 72px; /* header height space */
    }
    .hero {
    ...
    .btn {
      ...
      box-shadow: 0 8px 30px rgba(227,107,43,0.12);
      transform: translateZ(0);
      transition: transform 0.22s ease, box-shadow 0.22s;
    }
    .btn:hover {
      transform: translateY(-4px);
      box-shadow: 0 18px 40px rgba(227,107,43,0.18);
    }
    .btn:active {
    ...
    .panel {
      ...
      max-width: 420px;
      background: linear-gradient(180deg, #071017, #0f1a1f);
      z-index: 90;
      padding: 28px;
      box-shadow: -14px 0 40px rgba(0,0,0,0.6);
      transition: right 0.36s cubic-bezier(0.2,0.9,0.18,1);
      display: flex;
    ...
    .modal {
      ...
      visibility: hidden;
      opacity: 0;
      transition: opacity 0.25s ease, visibility 0.25s 0.25s;
      z-index: 80;
    }
    .modal.visible {
    ...
    .modal-card {
      ...
      animation: cardIn 0.4s cubic-bezier(0.2,0.9,0.18,1) both;
      display: grid;
...
<body>
      ...
      <div class="left">
        ...
        <div class="info-card" aria-hidden="false" style="margin-top:26px;">
          <div>
            ...
            <div style="font-size:13px;color:rgba(255,255,255,0.8);margin-top:6px;max-width:480px">
              Pubg content creator 🔥 34 tournament winner 🥇, Tdm player, Pakistan #3 player, Account seller, GFX designer, editor.
              <div style="margin-top:8px;color:rgba(255,255,255,0.65);font-size:13px">
    ...
    <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
      <div class="modal-left">
        ...
        <div class="social-grid">
          <!-- WhatsApp with direct message -->
          <a class="social" href="https://wa.me/923348666640?text=Hi%20bro!" target="_blank" rel="noopener noreferrer">
        ...
        <div style="margin-top:14px;color:rgba(255,255,255,0.65);font-size:13px">
      ...
      <div class="modal-right">
        ...
        <div style="display:flex;gap:10px;margin-top:6px">
          <div style="padding:10px;border-radius:8px;background:linear-gradient(180deg,#151515,#0b0b0b);text-align:center">
            <div style="font-size:12px;color:rgba(255,255,255,0.7)">Entry Fee</div>
            <div style="font-weight:900;font-size:18px">200</div>
          </div>
          <div style="padding:10px;border-radius:8px;background:linear-gradient(180deg,#151515,#0b0b0b);text-align:center">
            <div style="font-size:12px;color:rgba(255,255,255,0.7)">Prize Pool</div>
            <div style="font-weight:900;font-size:18px">5K + Int'l entry free</div>
          </div>
        </div>
        <div style="display:flex;gap:8px;margin-top:10px">
          <button class="btn" onclick="window.open('https://wa.me/923348666640?text=Hi%20bro!','_blank')">WhatsApp</button>
  ...
  <aside class="panel" id="aboutPanel" aria-hidden="true">
    <div class="close-btn" id="closeAbout">&larr;</div>
    <h3>About</h3>
    ...
    <div class="links">
      <a href="https://wa.me/923348666640?text=Hi%20bro!" target="_blank" rel="noopener noreferrer">WhatsApp — +92 334 8666640</a>
  ...
  <aside class="panel" id="contactPanel" aria-hidden="true">
    <div class="close-btn" id="closeContact">&larr;</div>
    <h3>Contact</h3>
